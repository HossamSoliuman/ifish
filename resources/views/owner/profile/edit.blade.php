    ...
    <div id="formControls" class="mb-5">
        <div class="card">
            <div class="card-body pb-2">
                <form action="{{ route('owner.profile.update', $user->id) }}" id="createForm" method="post"
                        ...
                        <div class="col-xl-4">
                            <div class="form-group ">
                                <label for="phone" class="form-label">{{ __('owner.dalal.modal.form.phone') }}<span
                                        class="text-danger">*</span></label>
                                <input type="text" name="phone" disabled value="{{ old('phone', $user->phone) }}"
                            ...
                            <div class="form-group ">
                                <label for="email"
                                    class="form-label">{{ __('owner.customers.modal.labels.email') }}<span
                                        class="text-danger">*</span></label>
                                <input type="email" name="email" disabled value="{{ old('email', $user->email) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4">
                                ...
                                <input type="text" name="fishing_license_number"
                                    value="{{ old('fishing_license_number', $user->fishing_license_number) }}"
                                    class="form-control" placeholder="{{ __('owner.generated.placeholder_license') }}">
                            ...
                            <div class="col-xl-4">
                                ...
                                <input type="date" name="fishing_license_expiry"
                                    value="{{ old('fishing_license_expiry', $user->fishing_license_expiry) }}"
                                    class="form-control">
                            ...
                            <div class="col-xl-4">
                                ...
                                <select name="port_id" id="port_id" required class="form-control">
                                    ...
                                    @php
                                        $selectedGovernorateId =
                                            old('governorate_id') ?? ($user->governorate_id ?? null);
                                        $selectedPortId = old('port_id') ?? ($user->port_id ?? null);
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4">
                            <label for="password_confirmation"
                                class="form-label">{{ __('owner.generated.confirm_password') }}</label>
                            <input type="password" name="password_confirmation"
                                value="{{ old('password_confirmation') }}" class="form-control"
                                placeholder="{{ __('owner.generated.confirm_password') }}">
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            // تحميل الميناء عند اختيار المحافظة
