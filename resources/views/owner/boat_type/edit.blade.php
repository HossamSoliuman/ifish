    ...
    <div class="d-flex align-items-center mb-3">
        <div>
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">{{__('owner.boat_type.edit.title')}}</li>
            </ul>
    ...
    <div id="formControls" class="mb-5">
        <div class="card">
            <div class="card-body pb-2">
                <form action="{{ route('owner.boat_types.update', $data->id) }}" method="post" id="createForm" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row mb-3">
                        <div class="col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="name_ar" value="{{ old('name_ar', $data->name_ar) }}" class="form-control" required placeholder="{{ __('owner.boat_type.name') }}">
                        ...
                        <div class="col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="name_en" value="{{ old('name_en', $data->name_en) }}" class="form-control" required placeholder="{{ __('owner.boat_type.name_en') }}">
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="status" required class="form-control">
                                <option value="1" {{ (old('status') || $data->status) == 1 ? 'selected' : '' }}>{{ __('owner.boat_type.status_active') }}</option>
                                <option value="0" {{ (old('status') || $data->status) == 0 ? 'selected' : '' }}>{{ __('owner.boat_type.status_inactive') }}</option>
                            </select>
