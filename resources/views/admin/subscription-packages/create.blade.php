                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <div id="features_ar_wrapper" class="package-features-wrapper">
                            @php
                                $oldFeaturesAr = old('feature_ar', ['']);
                                if (!is_array($oldFeaturesAr)) {
                                    $oldFeaturesAr = [$oldFeaturesAr];
                                }
                            @endphp
                            @foreach($oldFeaturesAr as $index => $feature)
                    ...
                    <div class="col-md-6">
                        ...
                        <div id="features_en_wrapper" class="package-features-wrapper">
                            @php
                                $oldFeaturesEn = old('feature_en', ['']);
                                if (!is_array($oldFeaturesEn)) {
                                    $oldFeaturesEn = [$oldFeaturesEn];
                                }
                            @endphp
                            @foreach($oldFeaturesEn as $index => $feature)
